...
export const __wbg_moveboardpair_free: (a: number, b: number) => void;
export const __wbg_get_moveboardpair_0: (a: number) => number;
export const __wbg_set_moveboardpair_0: (a: number, b: number) => void;
export const __wbg_get_moveboardpair_1: (a: number) => number;
export const __wbg_set_moveboardpair_1: (a: number, b: number) => void;
...
export const board_play: (a: number, b: number) => void;
...
export const board_get_next_move_boards: (a: number) => [number, number];
...
export const board_is_threefold_rep: (a: number) => number;
export const get_best_move: (a: number, b: number) => number;
